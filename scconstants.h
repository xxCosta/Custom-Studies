...
namespace n_ACSIL
{
	...
	enum GraphicsSettingsEnum : int32_t
	{
		...
		, GRAPHICS_SETTING_TIMES_AND_SALES_GRID = 40
		, GRAPHICS_SETTING_TIMES_AND_SALES_BID_HIGHLIGHT = 41
		, GRAPHICS_SETTING_TIMES_AND_SALES_BID_HIGHLIGHT_TEXT = 42
		, GRAPHICS_SETTING_TIMES_AND_SALES_ASK_HIGHLIGHT = 43
		, GRAPHICS_SETTING_TIMES_AND_SALES_ASK_HIGHLIGHT_TEXT = 44
		, GRAPHICS_SETTING_CHART_VALUES_COLOR_OF_THE_PRICE_AND_TIME_BOXES = 45
		, GRAPHICS_SETTING_CHART_VALUES_CROSSHAIR = 46
		, GRAPHICS_SETTING_COLUMN_SEPARATOR_LINES = 47
		, GRAPHICS_SETTING_BUY_COLUMN_BACK = 48
		, GRAPHICS_SETTING_BUY_COLUMN_LINE = 49
		, GRAPHICS_SETTING_SELL_COLUMN_LINE = 50
		, GRAPHICS_SETTING_SELL_COLUMN_BACK = 51
		, GRAPHICS_SETTING_BID_COLUMN_BACK = 52
		, GRAPHICS_SETTING_ASK_COLUMN_BACK = 53
		, GRAPHICS_SETTING_ASK_BACKGROUND = 54
		, GRAPHICS_SETTING_BID_BACKGROUND = 55
		, GRAPHICS_SETTING_ASK_DEPTH_BACK = 56
		, GRAPHICS_SETTING_ASK_DEPTH = 57
		, GRAPHICS_SETTING_BID_DEPTH_BACK = 58
		, GRAPHICS_SETTING_BID_DEPTH = 59
		, GRAPHICS_SETTING_ASK_MARKET_ORDER_BACK = 60
		, GRAPHICS_SETTING_ASK_MARKET_ORDER = 61
		, GRAPHICS_SETTING_BID_MARKET_ORDER_BACK = 62
		, GRAPHICS_SETTING_BID_MARKET_ORDER = 63
		, GRAPHICS_SETTING_BEST_BID_ASK_BOX_BACK = 64
		, GRAPHICS_SETTING_BUY_ORDER_QUANTITY_TEXT = 65
		, GRAPHICS_SETTING_SELL_ORDER_QUANTITY_TEXT = 66
		, GRAPHICS_SETTING_DAILY_HIGH_LINE = 67
		, GRAPHICS_SETTING_DAILY_LOW_LINE = 68
		...
		, GRAPHICS_SETTING_LAST_PRICE_BACKGROUND_ASK_TRADE = 76
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_BID_TRADE = 77
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_ASK_TRADE = 78
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_BACKGROUND_BID_TRADE = 79
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_BACKGROUND_ASK_TRADE = 80
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_BID_TRADE_SAME_PRICE_AND_SIDE_BACKGROUND = 81
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_ASK_TRADE_SAME_PRICE_AND_SIDE_BACKGROUND = 82
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_BID_TRADE_SAME_PRICE_AND_SIDE_TEXT = 83
		, GRAPHICS_SETTING_CUMULATIVE_LAST_SIZE_ASK_TRADE_SAME_PRICE_AND_SIDE_TEXT = 84
		, GRAPHICS_SETTING_RECENT_BID_VOLUME = 85
		, GRAPHICS_SETTING_RECENT_ASK_VOLUME = 86
		, GRAPHICS_SETTING_LAST_TRADED_RECENT_BID_VOLUME_BACK = 87
		, GRAPHICS_SETTING_LAST_TRADED_RECENT_ASK_VOLUME_BACK = 88
		, GRAPHICS_SETTING_LAST_TRADED_RECENT_BID_VOLUME_TEXT = 89
		, GRAPHICS_SETTING_LAST_TRADED_RECENT_ASK_VOLUME_TEXT = 90
		, GRAPHICS_SETTING_TRADED_TOTAL_VOLUME = 91
		, GRAPHICS_SETTING_TRADED_BID_VOLUME = 92
		, GRAPHICS_SETTING_TRADED_ASK_VOLUME = 93
		, GRAPHICS_SETTING_BID_MARKET_DEPTH_PULLING_STACKING = 94
		, GRAPHICS_SETTING_BID_MARKET_DEPTH_PULLING_STACKING_NEGATIVE = 95
		, GRAPHICS_SETTING_ASK_MARKET_DEPTH_PULLING_STACKING = 96
		, GRAPHICS_SETTING_ASK_MARKET_DEPTH_PULLING_STACKING_NEGATIVE = 97
		, GRAPHICS_SETTING_BID_VOLUME_BAR = 98
		, GRAPHICS_SETTING_ASK_VOLUME_BAR = 99
		, GRAPHICS_SETTING_VOLUME_BARS = 100
		, GRAPHICS_SETTING_TOTAL_PERCENTAGE_TEXT = 101
		, GRAPHICS_SETTING_RECENT_BID_VOLUME_VOLUME_BAR = 102
	...
	enum CustomDrawFunctionDrawOrderEnum : int32_t
	{
		DRAW_ORDER_UNSET = 0
		, DRAW_ORDER_LOWEST
		, DRAW_ORDER_ABOVE_MAIN_GRAPH_BELOW_STUDIES
		, DRAW_ORDER_ABOVE_ALL_GRAPHS_BELOW_DRAWINGS
		, DRAW_ORDER_HIGHEST
	};
}
